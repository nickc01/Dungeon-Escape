...
class AnimatedEntity : public Entity
{
	...
	std::map<std::string, std::vector<Sprite>> animationGroups; //The list of all sprite groups. Each group represents a series of sprites that are part of an animation
